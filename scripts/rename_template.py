...
It renames all the occurrences of crowd_navigation_mt (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the crowd_navigation_mt folder
        os.rename(
            os.path.join(root_dir_path, "exts", "crowd_navigation_mt", "crowd_navigation_mt"),
            os.path.join(root_dir_path, "exts", "crowd_navigation_mt", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "crowd_navigation_mt"), os.path.join(root_dir_path, "exts", new_name))
