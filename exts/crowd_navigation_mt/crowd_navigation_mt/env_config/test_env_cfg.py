...
from omni.isaac.lab_assets.anymal import ANYMAL_D_CFG, ANYMAL_LIDAR_CFG
...
class TestSceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        terrain_generator=terrains.TEST_NAV_TERRAIN_CFG,
    ...
    # for initial tests with navigation policy LiDAR is used 
    #        
    ...
    # LiDAR Scanner for Navigation Policy
    ...
    def __post_init__(self):
        ...
        # not initialized and therefore not post initialization step needed
        #
