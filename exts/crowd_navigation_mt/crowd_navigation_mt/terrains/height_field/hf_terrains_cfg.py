...
#############################################################
# PLR height field terrains implementation
#############################################################

@configclass
class HfDiscreteObstaclesWedgeTerrainCfg(HfTerrainBaseCfg):
    """Configuration for a discrete obstacles height field terrain."""

    function = hf_terrains.discrete_obstacles_terrain_wedge
    ...
    platform_width: float = 1.0
    """The width of the square platform at the center of the terrain. Defaults to 1.0."""
    wedge_width_range: tuple[float, float] = MISSING
    """The width of the wedge. Defaults to 1.0."""
    wedge_depth_range: tuple[float, float] = MISSING
    """The depth of the wedge. Defaults to 1.0."""
    wedge_thickness: float = 0.5
    """The thickness of the wedge. Defaults to 0.5."""


@configclass
class HfDiscreteLShapedPassageTerrainCfg(HfTerrainBaseCfg):
    """Configuration for a discrete obstacles height field terrain."""

    function = hf_terrains.l_shaped_passage_terrain
    ...
    platform_width: float = 1.0
    """The width of the square platform at the center of the terrain. Defaults to 1.0."""
    l_width_range: tuple[float, float] = MISSING
    """The width of the passage. Defaults to 1.0."""
    l_side_range: tuple[float, float] = MISSING
    """The depth of the passage. Defaults to 1.0."""


@configclass
class HfDiscreteSShapedPassageTerrainCfg(HfTerrainBaseCfg):
    """Configuration for a discrete obstacles height field terrain."""

    function = hf_terrains.s_shaped_passage_terrain
    ...
    platform_width: float = 1.0
    """The width of the square platform at the center of the terrain. Defaults to 1.0."""
    s_width_range: tuple[float, float] = MISSING
    """The width of the passage. Defaults to 1.0."""
    s_side_range: tuple[float, float] = MISSING
    """The depth of the passage. Defaults to 1.0."""
    s_length_range: tuple[float, float] = MISSING
    """The length of the passage. Defaults to 1.0."""
    closes_prob: float = 0.5
    """The probability of the passage closing. Defaults to 0.5."""
...
@configclass
class HfDiscreteObstaclesCellSideTerrainCfg(HfTerrainBaseCfg):
    """Configuration for a discrete obstacles height field terrain."""

    function = hf_terrains.discrete_obstacles_cell_side_terrain
    ...
    platform_width: float = 1.0
    """The width of the square platform at the center of the terrain. Defaults to 1.0."""
    cell_wall_width: float = 2.0
    """Width of the cell side wall"""
    cell_wall_thickness: float = 0.5
    """Thickness of the cell side wall"""
