...
@configclass
class PPOTeacherBetaCfg(PPOBaseBetaCfg):
    run_name = "PPO_Beta"
...
@configclass
class PPOTeacherConvCfg(PPOBaseBetaLidarConvCfg):
    run_name = "Static_Gru"
...
@configclass
class PPOTeacherNoGruConvCfg(PPOBaseBetaLidarConvCfg):
...
######################################################################
@configclass
class PPOCfgDEV(PPOTeacherBetaCfg):
    logger = "tensorboard"
    run_name = "Debug"
    # max_iterations = 10
